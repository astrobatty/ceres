...
def LeapSecUpdate():
	os.system('wget https://web.archive.org/web/20190822211801/http://maia.usno.navy.mil/ser7/leapsec.dat')
...
def IersUpdate():
	...
	os.system('wget https://web.archive.org/web/20190902101132/http://maia.usno.navy.mil/ser7/finals2000A.data')
